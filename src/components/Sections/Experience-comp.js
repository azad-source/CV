...
export default class {
    ...
    init() {
        let section = addElm('section', 'section-block', false, 'experience');
        let contentWrapper = addElm('div', 'content-wrapper');
        let h2 = addElm('h2', false, 'Experience');
        ...
        for (let key in experienceArr) {
            ...
            let h3 = addElm('h3', false, experienceArr[key]['employe']);
            let experienceText = addElm('div', 'experience-block-text');
            let company = addElm('strong', false, `${experienceArr[key]['company']} `);
