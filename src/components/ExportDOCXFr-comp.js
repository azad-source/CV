    ...
    init() {
        ...
        doc.addSection({
            ...
            children: [
                ...
                this.space(),
                this.h3('Frontend développeur'),
                this.text('SKB Kontur - Samara', '888888', 18),
                this.text('mars 2021 – actuellement', '888888', 18),
                this.text(`Développer le SPA dans le framework React JS, en travaillant avec l'architecture Redux en utilisant des concepts complexes orientés objet pour améliorer les performances des sites Web`),
                this.text('Langues/Frameworks/Bibliothèques: html5, css3, saas/scss, js es5/6/7, TypeScript, ReactJS, React Component, Redux, NodeJS', '555555', 18),
                this.text('Outils: VS Code, git, webpack, babel, Storybook, photoshop, figma', '555555', 18),
                this.space(1),
                this.h3('Développeur Web'),
                this.text('Plusmedia - Samara', '888888', 18),
                this.text('janvier 2019 - février 2021', '888888', 18),
